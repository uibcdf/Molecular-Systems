...
class AlaninePentapeptideVacuum():
    ...
    def __init__(self, forcefield='AMBER14', constraints='h_bonds', hydrogen_mass=None):
        ...
        >>> dialanine = AlaninePentapeptideVacuum(forcefield='xxx')
        ...
        from .files import alanine_pentapeptide
        file_pdb = alanine_pentapeptide['vacuum.pdb']
...
class AlaninePentapeptideImplicitSolvent():
    ...
    def __init__(self, forcefield='AMBER14', implicit_solvent='OBC1', solute_dielectric=1.0,
        ...
        >>> from simtk import unit
        >>> dialanine = AlaninePentapeptideImplicitSolvent(forcefield='xxx')
...
class AlaninePentapeptideExplicitSolvent():
    ...
    def __init__(self, forcefield = 'AMBER14', water_model = 'TIP3P', rigid_water = True, constraints = 'h_bonds', hydrogen_mass = None,
        ...
        >>> from simtk import unit
        >>> dialanine = AlaninePentapeptideExplicitSolvent()
        ...
        from molsysmt import convert
        from .files import alanine_pentapeptide
        file_pdb = alanine_pentapeptide['octahedral_14.pdb']
        item_modeller = convert(file_pdb, to_form='openmm.Modeller')
