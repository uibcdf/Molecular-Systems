...
class NotImplementedMethodError(NotImplementedError):
    ...
    NotImplementedMethodError
        ...
        the API documentation, and the link to the issues board of OpenMolecularSystems' GitHub repository.

    Examples
    --------
    >>> from openmolecularsystems._private_tools.exceptions import NotImplementedMethodError
    ...
    def __init__(self):
        ...
        from openmolecularsystems import __github_issues_web__
...
class BadCallError(ValueError):
    ...
    BadCallError
        ...
        issues board of OpenMolecularSystems' GitHub repository.

    Examples
    --------
    >>> from openmolecularsystems._private_tools.exceptions import BadCallError
